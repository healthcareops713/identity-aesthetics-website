(function(){
  ...
  if(finder){
    var data={
      "lines":[["Neurotoxin","Botox, Dysport, Xeomin or Jeuveau","injectables.html","Soften expression lines while preserving natural movement."],["Planning","Complete Facial Balancing","treatment-complete-facial-balancing.html","Evaluate facial relationships before selecting a product."],["Skin quality","Laser Rejuvenation","treatment-laser-rejuvenation.html","Address etched texture, pigment and overall skin quality."]],
      "volume":[["Contour","Dermal Fillers","injectables.html","Restore or refine volume with an anatomy-led plan."],["Biostimulation","Radiesse or Sculptra","treatment-radiesse.html","Discuss structural support and collagen-focused options."],["Advanced planning","Complete Facial Balancing","treatment-complete-facial-balancing.html","Build a comprehensive plan across multiple facial areas."]],
      "pigment":[["Broadband light","Sciton BBL","treatment-sciton-profile-bbl.html","Explore filter-selected care for sun damage, redness and uneven color."],["Thulium laser","LaseMD","treatment-lasemd.html","Discuss pigment, texture and customized ampoule pathways."],["Skin renewal","Glo2Facial","treatment-glo2facial.html","Consider a gentler exfoliation, oxygenation and infusion ritual."]],
      "texture":[["Collagen induction","Microneedling","microneedling.html","Support texture refinement through controlled renewal."],["Resurfacing","Laser Rejuvenation","treatment-laser-rejuvenation.html","Compare LaseMD and Sciton options for scars, texture and stretch marks."],["Surface renewal","Dermaplaning","dermaplaning.html","Create a smoother surface by removing dead skin and fine vellus hair."]],
      "wellness":[["Medical weight management","GLP-1 Consultation","treatment-glp1-weight-loss-consultation.html","Review candidacy, medication options, labs and supervision."],["Hormone health","Hormone Optimization","treatment-hormone-optimization-women.html","Evaluate symptoms in context for women or men."],["Physician-guided","Peptide Therapy","treatment-physician-supervised-peptide-therapy.html","Begin with an evidence-aware medical consultation."]],
      "body":[["Body goals","Body Contouring","treatment-body-contouring.html","Discuss non-surgical options selected for your goals."],["Hair reduction","Laser Hair Removal","treatment-laser-hair-removal.html","Plan a series around treatment area and skin/hair characteristics."],["Intimate wellness","Vaginal Rejuvenation with HIFU","treatment-vaginal-rejuvenation-hifu.html","Request a private consultation for candidacy and alternatives."]]
    };
    ...
    finder.querySelectorAll(".finder-choice").forEach(function(button){button.addEventListener("click",function(){
      ...
      book.href="book-consultation.html?service="+encodeURIComponent(button.dataset.service||title.textContent)+"&source=find-treatment";result.classList.add("show");result.scrollIntoView({behavior:"smooth",block:"nearest"});
    });});
  }

  document.querySelectorAll('a[href="book-consultation.html"]').forEach(function(link){if(!link.search){link.href="book-consultation.html?source="+encodeURIComponent(document.title);}});
